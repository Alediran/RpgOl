...
public class RpgOlHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<RpgOlDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}RpgOl.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<RpgOlDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}RpgOl.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<RpgOlApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}RpgOl.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<RpgOlApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}RpgOl.Application"));
            });
        }
    }
