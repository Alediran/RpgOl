...
public class EfCoreBoardRepository(IDbContextProvider<IRpgOlDbContext> dbContextProvider) : EfCoreRepository<IRpgOlDbContext, Board, Guid>(dbContextProvider), IBoardRepository
{
